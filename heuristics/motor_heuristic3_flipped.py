...
def infotodict(seqinfo):
    ...
    info = {t1w:[], motor1: [], motor2: [], motor3: [], motor4: [],
            lang1: [], lang2: [], fmap_pa: [], fmap_ap: []}
    ...
    for s in seqinfo:
        ...
        motor_keys = [motor1,motor2,motor3,motor4]
...
IntendedFor = {
    fmap_ap: {
        ...
        '{session}/func/sub-{subject}_{session}_task-motor_run-03_bold.nii.gz',
        '{session}/func/sub-{subject}_{session}_task-motor_run-04_bold.nii.gz',
        '{session}/func/sub-{subject}_{session}_task-lang_run-01_bold.nii.gz',
        '{session}/func/sub-{subject}_{session}_task-lang_run-02_bold.nii.gz',
    },
    fmap_pa: {
        '{session}/func/sub-{subject}_{session}_task-motor_run-01_bold.nii.gz',
        '{session}/func/sub-{subject}_{session}_task-motor_run-02_bold.nii.gz',
